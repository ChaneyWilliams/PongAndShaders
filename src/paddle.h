...
void PaddleDrawTheOriginal(AppContext* _app, Entity* _entity) {
    ...
    ShaderSetVector4(_entity->shaderId, "COLOR", color);
...
void PaddleDrawTheSequal(AppContext* _app, Entity* _entity) {
